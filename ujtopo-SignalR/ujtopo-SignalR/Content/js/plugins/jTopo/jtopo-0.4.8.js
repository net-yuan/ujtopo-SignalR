!function (window) {
    ...
    CanvasRenderingContext2D.prototype.JTopoRoundRect = function (a, b, c, d, e) {
        ...
        MouseCursor: {
            ...
            closed_hand: "url(../../Image/cur/closedhand.cur) 8 8, default"
        },
    ...
    function f(b, c, g) {
        ...
        this.initialize = function (b, c, d) {
            ...
            if (null != this.nodeA && null != !this.nodeZ) {
                ...
                if (b.length == 2)
                {
                    if (this.nodeA.text != '市电') {
                        if (this.nodeA.outLinks.length > 0) {
                            //console.log(b[1].x - this.nodeA.cx);
                            if (b[1].x - this.nodeA.cx > 0) {
                                b[0].x = b[0].x + 25;
                            }
